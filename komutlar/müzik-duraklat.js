...
.setDescription(`<a:emoji_200:740256355545383032>  | Oynatılan bir müziği duraklatabilmek için bir ses kanalında olmanız gerekmektedir!`)
...
.setColor(AloneDogru)
.setTitle("Duble Krallar |   Duraklat")
.setDescription(`<a:emoji_200:740256355545383032>   | \`${sarki.name}\` adlı müzik ${message.author} tarafından duraklatıldı!`) 
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL())
