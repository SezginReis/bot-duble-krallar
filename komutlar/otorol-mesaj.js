...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:ayarlar1:751520036149264454> **Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
  ...
  if(mesaj.length < 5) return message.channel.send('<a:ayarlar1:751520036149264454>  **Sayaç Hoşgeldin Mesaj Sistemi İçin En Az 5 Karakter Belirtebilirsin!**\n `**__Örnek__**: `-oto-rol-msg -uye- Hoşgeldin! senle beraber -uyesayisi- Kişiyiz!`')
  
 message.channel.send('<a:ayarlar1:751520036149264454> **Oto-Rol mesajı** `'+mesaj+'` **Olarak ayarlandı!**') 
