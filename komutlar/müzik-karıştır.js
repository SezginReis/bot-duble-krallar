...
.setColor(AloneDogru)
.setTitle("Duble Krallar |  Karıştır")
.setDescription(`<a:emoji_200:740256355545383032>  | Müzik Kuyruğu, ${message.author} tarafından karıştırıldı.`) 
...
.setTitle("• Hata: 009 •")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:emoji_200:740256355545383032>  | Müzik kuyruğunu karıştırabilmek için bir ses kanalında olmanız gerekmektedir!`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL());  
