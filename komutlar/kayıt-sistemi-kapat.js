...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:ayarlar1:751520036149264454>  **Bu komutu kullanabilmek için "\`Yönetici\`" yetkisine sahip olmalısın.**`);
 ...
 if(!rol) return message.channel.send(`<a:ayarlar1:751520036149264454>  **Bu özellik zaten kapalı! :wink: **`)
 
 
  message.channel.send(`<a:ayarlar1:751520036149264454>  **Kayıt Sistemi başarılı bir şekilde kapatıldı.**`)
