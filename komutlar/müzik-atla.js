...
.setDescription(`<a:emoji_200:740256355545383032>  **| Oynatılan bir müziği geçebilmek için bir ses kanalında olmanız gerekmektedir!**`)
...
.setColor(AloneDogru) 
.setTitle("Duble Krallar | Atla")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:emoji_200:740256355545383032>  **|** \`${sarki.name}\` **adlı müzik** ${message.author} **tarafından geçildi!**`) 
