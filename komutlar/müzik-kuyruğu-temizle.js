...
.setColor(AloneDogru)
.setTitle("Duble Krallar | Kuyruğu Temizle")
.setDescription(`<a:emoji_200:740256355545383032>  **| Müzik Kuyruğu, ${message.author} tarafından temizlendi.**`) 
...
.setTitle("• Hata: 011 •")
.setThumbnail(`https://drummofficial.com/wp-content/uploads/2017/08/equalizer3.gif`)
.setDescription(`<a:emoji_200:740256355545383032>   **| Müzik Kuyruğunu temizleyebilmek için bir ses kanalında olmanız gerekmektedir!**`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL());  
