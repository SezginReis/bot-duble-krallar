...
.setDescription(`<a:ayarlar1:751520036149264454> | Şu anda çalan müziği görebilmek için bir ses kanalında olmanız gerekmektedir!`)
...
.setColor("#22BF41")
.setDescription(`<a:ayarlar1:751520036149264454>  | Şu Anda Oynatılan:\n\nMüziğin Adı: \n\`${calan.name}\`\n\nMüziği Yükleyen Kanal: \n\`${calan.author}\` \n\nMüziğin Linki: \n[Youtube'den dinlemek için tıkla!](${calan.url})`)
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2020`, client.user.avatarURL())
